...
+------------------------+     +------------------------+     +------------------------+     +------------------------+
                                                                                                      ...
                                                                                                      v
+------------------------+     +------------------------+     +------------------------+     +------------------------+
| 8. Cuối ngày mới       | <-- | 7. Làm phần            | <-- | 6. Tự nhớ việc         | 🔴<- | 5. Mở lại              |
|    kiểm tra            |     |    đang gấp nhất       |     |    cần làm             |     |    việc đồ án          |
|    lab/deadline        |     |                        |     |                        |     |                        |
+------------------------+     +------------------------+     +------------------------+     +------------------------+
...
+----------------------------+     +----------------------------+     +----------------------------+     +----------------------------+
                                                                                                                   ...
                                                                                                                   v
+----------------------------+     +----------------------------+     +----------------------------+
| 7. AI gợi ý điều chỉnh     | <-- | 6. Cuối ngày cập nhật      | <-- | 5. Thực hiện theo          |
|    kế hoạch ngày sau       |     |    trạng thái              |     |    time-block              |
+----------------------------+     +----------------------------+     +----------------------------+
...
+----------------------------+     +----------------------------+     +----------------------------+
| 1. Đọc worksheet           | --> | 2. Gặp khái niệm           | 🔴-> | 3. Tìm Google hoặc         |
|    hoặc nghe giảng         |     |    chưa rõ                 |     |    hỏi người khác          |
+----------------------------+     +----------------------------+     +----------------------------+
                                                                                         |
                                                                                         v
+----------------------------+     +----------------------------+     +----------------------------+     +----------------------------+
| 7. Có thể hiểu sai         | <-- | 6. Áp dụng vào bài         | <-- | 5. Tự liên hệ với          | <-- | 4. Đọc nhiều nguồn         |
|    và phải sửa lại         |     |    Problem Card/workflow   |     |    bài lab                 |     |    khác nhau               |
+----------------------------+     +----------------------------+     +----------------------------+     +----------------------------+

🔴 = Bottleneck
```

**Bottleneck:** Kiến thức nền chưa đủ, nguồn giải thích bị rời rạc và chưa gắn trực tiếp với ngữ cảnh lab cụ thể.
...
+----------------------------+     +----------------------------+     +----------------------------+
| 1. Dán khái niệm           | --> | 2. AI giải thích           | --> | 3. AI đưa ví dụ            |
|    hoặc đoạn chưa hiểu     |     |    ngắn gọn                |     |    gần với điện tử/nhúng   |
+----------------------------+     +----------------------------+     +----------------------------+
                                                                                         |
                                                                                         v
+----------------------------+     +----------------------------+     +----------------------------+
| 6. Đối chiếu mentor/       | <-- | 5. Sinh viên tự viết lại   | 🟢<- | 4. AI gợi ý cách áp dụng   |
|    tài liệu chính thức     |     |    bằng lời của mình       |     |    vào output              |
+----------------------------+     +----------------------------+     +----------------------------+

🟢 = Human boundary
```

**Human boundary:** AI không được xem là nguồn đúng tuyệt đối. Với khái niệm quan trọng hoặc yêu cầu chấm điểm, sinh viên vẫn cần đối chiếu lại với worksheet, mentor hoặc tài liệu chính thức.
...
+----------------------------+     +----------------------------+     +----------------------------+
| 1. Mở group chat           | --> | 2. Đọc tin nhắn mới        | --> | 3. Kiểm tra email          |
+----------------------------+     +----------------------------+     +----------------------------+
                                                                                         |
                                                                                         v
+----------------------------+     +----------------------------+     +----------------------------+     +----------------------------+
| 7. Lặp lại nhiều lần       | <-- | 6. Ghi chú deadline        | <-- | 5. Hỏi lại bạn/mentor      | 🔴<- | 4. Mở worksheet/README     |
|    trong ngày              |     |    thủ công                |     |    nếu chưa chắc           |     |                            |
+----------------------------+     +----------------------------+     +----------------------------+     +----------------------------+

🔴 = Bottleneck
```

**Bottleneck:** Thông tin nằm rải rác ở nhiều kênh, người học phải tự kiểm tra và tự tổng hợp nên dễ bỏ sót deadline hoặc yêu cầu nộp bài.
...
+----------------------------+     +----------------------------+     +----------------------------+
| 1. Người học cung cấp      | --> | 2. AI trích xuất           | --> | 3. AI tạo checklist        |
|    thông báo/tài liệu      |     |    deadline/yêu cầu/link   |     |    theo ngày               |
+----------------------------+     +----------------------------+     +----------------------------+
                                                                                         |
                                                                                         v
+----------------------------+     +----------------------------+     +----------------------------+
| 6. Cập nhật lịch           | <-- | 5. Người học xác nhận      | 🟢<- | 4. AI đánh dấu thông tin   |
|    cá nhân                 |     |    với nguồn chính thức    |     |    chưa rõ/mâu thuẫn       |
+----------------------------+     +----------------------------+     +----------------------------+

🟢 = Human boundary
```

**Human boundary:** AI chỉ tổng hợp từ thông tin được cung cấp, không tự tạo deadline và không thay thế thông báo chính thức của chương trình.
